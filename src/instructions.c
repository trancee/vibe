...
const instruction_t instructions[256] = {
    ...
    {0x0A, "ASL", ASL, Accumulator /* Implied */, 1, 2, false},
    ...
    {0x22, "JAM", NOP, Implied, 0, 2 /* 1 */, true},
    ...
    {0x2A, "ROL", ROL, Accumulator /* Implied */, 1, 2, false},
    ...
    {0x32, "JAM", NOP, Implied, 0, 2 /* 1 */, true},
    ...
    {0x42, "JAM", NOP, Implied, 0, 2 /* 1 */, true},
    ...
    {0x52, "JAM", NOP, Implied, 0, 2 /* 1 */, true},
    ...
    {0x62, "JAM", NOP, Implied, 0, 2 /* 1 */, true},
    ...
    {0x6A, "ROR", ROR, Accumulator /* Implied */, 1, 2, false},
    ...
    {0x72, "JAM", NOP, Implied, 0, 2 /* 1 */, true},
    ...
    {0x8B, "ANE", ANE, Immediate, 2, 2, true}, // 6502: XAA
    ...
    {0xB2, "JAM", NOP, Implied, 0, 2 /* 1 */, true},
    ...
    {0xCB, "SBX", SBX, Immediate, 2, 2, true}, // 6502: AXS
    ...
    {0xD2, "JAM", NOP, Implied, 0, 2 /* 1 */, true},
    ...
    {0xEB, "SBC", SBC, Immediate, 2, 2, true}, // USB?
